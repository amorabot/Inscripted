...
//            return true;
            ...
            switch (stat){
                case "rarity":
                    ...
                    if (dataContainer.has(new NamespacedKey(plugin, "rarity"), PersistentDataType.STRING)){
                        player.sendMessage(color("&cRarity already defined!"));
                    } else {
                        ...
                        player.sendMessage(color("&aRarity modified!"));
                    }
                    break;
                case "ilvl":
                    if (dataContainer.has(new NamespacedKey(plugin, "ilvl"), PersistentDataType.INTEGER)){
                        player.sendMessage(color("&cThe item already has a item level!"));
                    } else {
                        ...
                        item.setItemMeta(meta);
                        player.sendMessage(color("&aIlvl stored!"));
                    }
                    break;
                case "equipment-type":
                    if (dataContainer.has(new NamespacedKey(plugin, "equipment-type"), PersistentDataType.STRING)){
                        player.sendMessage(color("&cItem type already defined!"));
                    } else {
                        ...
                        item.setItemMeta(meta);
                        player.sendMessage(color("&aEquipment type stored!"));
                    }
                    break;
            }
        }
