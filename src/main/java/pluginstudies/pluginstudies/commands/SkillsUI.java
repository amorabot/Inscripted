...
//        profileManager = plugin.getProfileManager();
        ...
        pointsMeta.setDisplayName(color("&e&lSkill points"));
        pointsMeta.setLore(Arrays.asList(
                color("&7You have" + "10" + "points"),
                color("&7"),
        ...
        intelligenceMeta.setDisplayName(color("&9&LIntelligence"));
        intelligenceMeta.setLore(Arrays.asList(
                color("&7"),
                color("&7Click here to allocate points or dealocate")
        ));
        ...
        agilityeMeta.setDisplayName(color("&A&LAgility"));
        ...
        strengthMeta.setDisplayName(color("&C&LStrength"));
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args){
        ...
        if (!(sender instanceof Player)){
            log("Esse comando é exclusivo para players.");
            return true;
        }
