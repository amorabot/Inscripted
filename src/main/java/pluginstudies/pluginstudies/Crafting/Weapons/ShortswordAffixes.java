...
public enum ShortswordAffixes implements TableAcessInterface {
    ...
    PREFIXES(               new Pair<>("Added physical DMG",
            ...
            new Pair<>("Added lightning DMG",
                    mapRanges(new Pair<>(3, generateRange(1,1,6,6)),
                            new Pair<>(13, generateRange(1,2,27,28)),
                            new Pair<>(19, generateRange(1,3,41,43)),
                            new Pair<>(31, generateRange(2,5,58,61)),
                            new Pair<>(34, generateRange(2,6,72,76)),
                            new Pair<>(42, generateRange(2,7,91,96)),
                            new Pair<>(51, generateRange(3,9,110,116)),
                            new Pair<>(63, generateRange(4,11,133,140)),
                            new Pair<>(74, generateRange(4,13,158,166)) ) ),
    ...
    SUFFIXES(               new Pair<>("Accuracy",
                    mapRanges(new Pair<>(1, generateRange(5,15)),
                            ...
                            new Pair<>("Attack Speed%",
                    mapRanges(new Pair<>(1, generateRange(5,7)),
                            new Pair<>(11, generateRange(8,10)),
                            new Pair<>(22, generateRange(11,13)),
                            new Pair<>(30, generateRange(14,16)),
                            new Pair<>(37, generateRange(17,19)),
                            new Pair<>(45, generateRange(20, 22)),
                            new Pair<>(60, generateRange(23,25)),
                            new Pair<>(77, generateRange(26, 27)) ) ),
    ...
    ShortswordAffixes(Pair<String, Map<Integer, List<int[]>>>... affixMapEntries){
