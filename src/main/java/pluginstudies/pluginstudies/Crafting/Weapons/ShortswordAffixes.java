...
public enum ShortswordAffixes implements AffixTableAcessInterface {
    ...
    PREFIXES(               new PairDT<>("Added physical DMG",
            ...
            new PairDT<>("Added lightning DMG",
                    mapRanges(new PairDT<>(3, generateRange(1,1,6,6)),
                            new PairDT<>(13, generateRange(1,2,27,28)),
                            new PairDT<>(19, generateRange(1,3,41,43)),
                            new PairDT<>(31, generateRange(2,5,58,61)),
                            new PairDT<>(34, generateRange(2,6,72,76)),
                            new PairDT<>(42, generateRange(2,7,91,96)),
                            new PairDT<>(51, generateRange(3,9,110,116)),
                            new PairDT<>(63, generateRange(4,11,133,140)),
                            new PairDT<>(74, generateRange(4,13,158,166)) ) ),
    ...
    SUFFIXES(               new PairDT<>("Accuracy",
                    mapRanges(new PairDT<>(1, generateRange(5,15)),
                            ...
                            new PairDT<>("Attack Speed%",
                    mapRanges(new PairDT<>(1, generateRange(5,7)),
                            new PairDT<>(11, generateRange(8,10)),
                            new PairDT<>(22, generateRange(11,13)),
                            new PairDT<>(30, generateRange(14,16)),
                            new PairDT<>(37, generateRange(17,19)),
                            new PairDT<>(45, generateRange(20, 22)),
                            new PairDT<>(60, generateRange(23,25)),
                            new PairDT<>(77, generateRange(26, 27)) ) ),
    ...
    ShortswordAffixes(PairDT<String, Map<Integer, List<int[]>>>... affixMapEntries){
