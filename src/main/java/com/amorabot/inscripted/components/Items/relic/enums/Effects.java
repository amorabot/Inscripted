...
////import com.amorabot.inscripted.skill.casting.EffectsCooldownManager;
...
////            if (!EffectsCooldownManager.effecTriggered(caster.getUniqueId(),this)){return;}
...
////                if (!EffectsCooldownManager.effecTriggered(caster.getUniqueId(),this)){
