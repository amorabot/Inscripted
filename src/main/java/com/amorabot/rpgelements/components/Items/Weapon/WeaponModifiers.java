...
public enum WeaponModifiers implements ItemModifier {
    ...
    PERCENT_PHYSICAL(Affix.PREFIX, "+@value1@% Inc. Physical DMG", 6,
    ...
    PERCENT_ELEMENTAL(Affix.PREFIX, "+@value1@% Inc. Elemental DMG", 6,
    ...
    ADDED_PHYSICAL(Affix.PREFIX, "+@value1@ - @value2@ Physical DMG", 6,
                    TargetStats.PHYSICAL_DAMAGE, ValueTypes.FLAT, RangeTypes.DOUBLE_RANGE,
                    List.of(ModTags.DAMAGE, ModTags.PHYSICAL), false, 1),
    ADDED_FIRE(Affix.PREFIX, "+@value1@ - @value2@ Fire DMG", 6,
    ...
    LIFE_ON_HIT(Affix.SUFFIX, "+@value1@ Life per hit", 4,
    ...
    ACCURACY(Affix.SUFFIX, "+@value1@ Accuracy", 5,
            ...
            List.of(ModTags.UTILITY), false, 1),
    BLEEDING(Affix.SUFFIX, "+@value1@% Bleeding chance", 3,
